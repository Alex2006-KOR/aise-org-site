...
::: tip 읽는 자리 — 배경 및 철학 (1/3)
[배경 및 철학](/background) 대분류의 첫 글입니다. [Home](/)이 "세션이 끝나면 아무것도 남지
않는다"는 문제를 던졌다면, 이 페이지는 그 문제에서 **어떤 결심들이 갈라져 나왔는지**를
따라갑니다. 다음 [일반적인 방식과 무엇이 다른가](/real-world-vs-aise)는 그 결심이 흔한
방식과 실제로 어디서 갈라지는지를 대조합니다 — 즉 이 페이지는 "무엇을 믿는가", 다음
페이지는 "그래서 무엇이 달라지는가"입니다.
:::
...
**다음으로.** 이 다섯 가지가 흔히 하는 방식과 실제로 어디서 갈라지는지 →
